...
//        Lang = String.valueOf(locale);
       // Toast.makeText(getApplicationContext(), String.valueOf(Lang), Toast.LENGTH_LONG).show();
        ...
        String fontPathBold1 = "fonts/gothambook.ttf";
                    ...
                    public void onClick(View v) {
                        ...
                        goButton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                preferenceEditor.commit();
                                vdata.setApiUrl("http://"+preferenceSettings.getString("localip"," 68.183.190.117")+"/api/");
                                vdata.setServerURL("http://"+preferenceSettings.getString("localip","68.183.190.117")+"/");
                                bdialog.dismiss();
                                checkBackendType();
//                                roomdata();
                            }
...
//                        vdata.setServerURL(ServerUrl);
                        vdata.setApiUrl("http://68.183.190.117/api/");
                        vdata.setServerURL("http://68.183.190.117/");
